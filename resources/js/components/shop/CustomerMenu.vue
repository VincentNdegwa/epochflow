<template>
    <Menu as="div" class="relative">
        <MenuButton class="flex items-center gap-2 rounded-full bg-background p-2 text-sm font-medium hover:bg-accent">
        ...
        <transition enter-active-class="transition duration-100 ease-out"
            ...
            <MenuItems
                ...
                <div class="px-1 py-1">
                    ...
                    <User class="mr-2 h-4 w-4" :class="active ? 'text-accent-foreground' : 'text-foreground/70'" />
                    Profile
                    </Link>
                    </MenuItem>
                    <MenuItem v-slot="{ active }">
                    <Link :href="route('password.edit')" :class="[
                        active ? 'bg-accent text-accent-foreground' : 'text-foreground',
                        'group flex w-full items-center rounded-md px-2 py-2 text-sm'
                    ]">
                    <Lock class="mr-2 h-4 w-4" :class="active ? 'text-accent-foreground' : 'text-foreground/70'" />
                    Change Password
                    </Link>
                    </MenuItem>
