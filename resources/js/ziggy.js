const Ziggy = {
    ...
    routes: {
        ...
        'customer.login': {
            uri: 'store\/{storeSlug}\/login',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug'],
        },
        ...
        'customer.register': {
            uri: 'store\/{storeSlug}\/register',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug'],
        },
        'customer.register.attempt': {
            uri: 'store\/{storeSlug}\/register',
            methods: ['POST'],
            parameters: ['storeSlug'],
        },
        'customer.logout': {
            uri: 'store\/{storeSlug}\/logout',
            methods: ['POST'],
            parameters: ['storeSlug'],
        },
        'cart.index': {
            uri: 'store\/{storeSlug}\/cart',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug'],
        },
        'cart.store': {
        ...
        'cart.update': {
            uri: 'store\/{storeSlug}\/cart\/{cartItem}',
            methods: ['PUT'],
            parameters: ['storeSlug', 'cartItem'],
        ...
        'checkout.pay': {
            uri: 'store\/{storeSlug}\/checkout\/pay\/{order_id}',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug', 'order_id'],
        },
        'store.products.show': {
            uri: 'store\/{storeSlug}\/products\/{slug}',
            methods: ['GET', 'HEAD'],
            wheres: { slug: '.*' },
            parameters: ['storeSlug', 'slug'],
        },
        'customer.orders.index': {
            uri: 'store\/{storeSlug}\/orders',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug'],
        },
        'customer.orders.show': {
            uri: 'store\/{storeSlug}\/orders\/{slug}',
            methods: ['GET', 'HEAD'],
            parameters: ['storeSlug', 'slug'],
        },
        ...
        'stores.index': { uri: 'stores', methods: ['GET', 'HEAD'] },
        'stores.create': { uri: 'stores\/create', methods: ['GET', 'HEAD'] },
        'stores.store': { uri: 'stores', methods: ['POST'] },
        'stores.edit': {
            uri: 'stores\/{slug}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['slug'],
        },
        'stores.update': {
