...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: props.product
            ? `/products/${props.product.id}/edit`
            : '/products/create',
    },
];
                    ...
                    <div class="space-y-4 p-4">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute top-2 left-3 text-foreground/70"
                                        >$</span
                                    >
                                    <input
                                        id="price"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full rounded-md border bg-transparent px-3 py-2"
                                    :class="{
                                        'border-destructive': form.errors.stock,
                                    }"
                                    required
                                />
                                <p
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                ...
                                />
                                <span class="text-sm"
                                    >Product is active and available for
                                    purchase</span
                                >
                            </label>
                        </div>
                ...
                <div class="rounded-xl border bg-card">
                    ...
                    <div class="p-4">
                        <div
                            ...
                            :class="{
                                'border-destructive': form.errors.images,
                            }"
                        >
                            <!-- Existing Images -->
                            <div
                            ...
                            >
                                ...
                                <button
                                    ...
                                    class="absolute inset-0 flex items-center justify-center bg-destructive/90 opacity-0 transition-opacity group-hover:opacity-100"
                                >
                                    <Trash2
                            ...
                            <!-- Upload Button -->
                            <label
                                class="relative aspect-square cursor-pointer rounded-lg border-2 border-dashed border-border hover:border-primary"
                            >
                                <input
                                    type="file"
                                    @change="addImages"
                                ...
                                />
                                <div
                                    class="absolute inset-0 flex flex-col items-center justify-center text-foreground/70"
                                >
