      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          <div>
            ...
            <p class="mt-4 text-2xl font-medium">${{ product.price }}</p>
          </div>
          ...
          <!-- Add to Cart Form -->
          <form v-if="product.in_stock" @submit.prevent="addToCart" class="space-y-4">
            <div>
              ...
              <div class="flex items-center gap-2">
                <button
                  ...
                  class="h-9 w-9 rounded-md border flex items-center justify-center"
                >
                  <Minus class="h-4 w-4" />
                </button>
                <input
            ...
            >
              <ShoppingCart v-if="!form.processing" class="h-5 w-5" />
              <span v-else class="h-5 w-5 border-2 border-current border-r-transparent rounded-full animate-spin"></span>
              Add to Cart
            </button>
          </form>
        </div>
