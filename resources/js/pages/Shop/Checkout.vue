          ...
          <form @submit.prevent="submitOrder" class="space-y-8">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label for="shipping_address" class="block text-sm font-medium mb-1">
                    Address
                  </label>
                  <input
                    id="shipping_address"
                    ...
                    type="text"
                    class="w-full h-9 rounded-md border bg-background px-3"
                    required
                  />
                </div>
                <div>
                  <label for="shipping_city" class="block text-sm font-medium mb-1">
                    City
                  </label>
                  <input
                    id="shipping_city"
                ...
                <div>
                  <label for="shipping_state" class="block text-sm font-medium mb-1">
                    State
                  </label>
                  <input
                    id="shipping_state"
                ...
                <div>
                  <label for="shipping_zip_code" class="block text-sm font-medium mb-1">
                    ZIP Code
                  </label>
                  <input
                ...
                <div class="md:col-span-2">
                  <label for="shipping_country" class="block text-sm font-medium mb-1">
                    Country
                  </label>
                  <select
                    id="shipping_country"
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <label class="flex items-center gap-2">
                  ...
                  />
                  <span class="text-sm">Same as shipping</span>
                </label>
              </div>

              <div v-if="!sameAsShipping" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label for="billing_address" class="block text-sm font-medium mb-1">
                    Address
                  </label>
                  <input
                    id="billing_address"
                ...
                <div>
                  <label for="billing_city" class="block text-sm font-medium mb-1">
                    City
                  </label>
                  <input
                    id="billing_city"
                ...
                <div>
                  <label for="billing_state" class="block text-sm font-medium mb-1">
                    State
                  </label>
                  <input
                    id="billing_state"
                ...
                <div>
                  <label for="billing_zip_code" class="block text-sm font-medium mb-1">
                    ZIP Code
                  </label>
                  <input
                    id="billing_zip_code"
                ...
                <div class="md:col-span-2">
                  <label for="billing_country" class="block text-sm font-medium mb-1">
                    Country
                  </label>
                  <select
                    id="billing_country"
            ...
            >
              <span v-if="form.processing" class="h-5 w-5 border-2 border-current border-r-transparent rounded-full animate-spin"></span>
              Place Order
            </button>
          </form>
        </div>
