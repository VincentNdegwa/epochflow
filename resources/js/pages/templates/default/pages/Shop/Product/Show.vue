    ...
    >
        ...
        <div class="mx-auto max-w-7xl px-4 py-12">
                            ...
                            <div class="mt-8 space-y-6">
                                ...
                                <div class="flex flex-col gap-4">
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        class="flex w-full items-center justify-center rounded-xl bg-primary px-8 py-4 text-base font-medium text-white shadow-sm hover:bg-primary/90 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
                                    >
                                        Add to Cart
                                    </Link>
                                    <button
            ...
            <div
                ...
                class="mt-16 rounded-2xl bg-gray-50 p-8"
            >
                <h2 class="text-2xl font-bold text-gray-900">
                    You may also like
                </h2>
                <div
                    class="mt-6 grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8"
                >
                    <Link
                    ...
                    >
                        ...
                        >
                            <img
                                :src="
                                    p.primary_image || '/images/placeholder.png'
                                "
                                :alt="p.name"
