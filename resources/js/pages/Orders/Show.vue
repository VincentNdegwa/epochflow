        ...
        <div class="md:col-span-2">
          <div class="rounded-lg bg-card overflow-hidden">
            ...
            <div class="divide-y">
              ...
              >
                <!-- Product Image -->
                <div class="h-20 w-20 flex-shrink-0 overflow-hidden rounded bg-muted">
                  <img
        ...
        <div class="space-y-6">
          ...
          <div class="rounded-lg bg-card p-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <div class="text-sm text-foreground/70">{{ order.user.email }}</div>
              </div>
            </div>
          </div>
          ...
          <div class="rounded-lg bg-card p-6">
            ...
            <div class="space-y-1 text-sm">
              ...
              <div>{{ order.billing_city }}, {{ order.billing_state }} {{ order.billing_zip_code }}</div>
          ...
          <div v-if="order.status === 'pending'">
            <button
              @click="cancelOrder"
              class="w-full btn-primary bg-destructive hover:bg-destructive/90"
            >
              Cancel Order
            </button>
          </div>
...
const cancelOrder = () => {
  if (confirm(`Are you sure you want to cancel order #${props.order.order_number}?`)) {
